...
export default function HomePage() {
    ...
    const fetchRates = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // ✅ Now update with new fetched rates
          setRates(data);
        }
      } catch (error) {
  ...
  }, []); // ✅ empty dependency array so it runs once and then with interval
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover:shadow-xl transition-shadow border-l-4 border-l-orange-500">
              <CardContent className="p-6">
            ...
            <Card className="hover:shadow-xl transition-shadow border-l-4 border-l-red-500">
              <CardContent className="p-6">
